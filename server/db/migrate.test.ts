...
describe("runMigrations", () => {
  it("applies the real migrations dir and records _migrations", () => {
    ...
    expect(appliedMigrations(dbPath)).toEqual(["0001_init.sql", "0002_project_repos.sql", "0003_forge_sessions.sql", "0004_auth_roles_teams.sql", "0005_milestones_sprints.sql", "0006_drop_mcp_connected.sql", "0007_task_keys.sql", "0008_wiki_share_links.sql"]);
    const db = new Database(dbPath);
