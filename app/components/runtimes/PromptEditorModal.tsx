...
function persistPromptEntity(args: {
  ...
  createSkill: ReturnType<typeof useCreateSkill>;
  updateSkill: ReturnType<typeof useUpdateSkill>;
  onClose: () => void;
}): void {
...
// Settings editor for Runtime agents + skills (global rule bundles). The
