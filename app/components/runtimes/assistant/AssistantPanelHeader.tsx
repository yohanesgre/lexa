import { EngineToggle } from "./AssistantModePicker";
import type { RuntimeMode } from "./AssistantModePicker";
import { AssistantFlameIcon } from "./AssistantFlameIcon";

// Assistant tier panel header (assistant-popover.html): flame glyph + phase-aware
// right slot.
  ...
  return (
    <div className="flex items-center justify-between" style={{ padding: "10px 12px", borderBottom: "1px solid var(--lx-border-default)" }}>
      ...
      {running ? (
        ...
        <EngineToggle enabled mode="assistant" onChange={onModeChange} />
      ) : (
