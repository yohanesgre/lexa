...
export function AssistantPanel({ editor, slug, documentType, documentId, engineSwitcherEnabled, onModeChange, onClose, onReview, reviewActive, appliedTaskId, rejectedTaskId }: {
  editor: Editor;
  slug: string;
