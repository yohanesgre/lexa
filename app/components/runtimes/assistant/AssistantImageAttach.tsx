...
// disabled with a tooltip pointing at Project Settings → Assistant vision.
export function AssistantImageAttach({ images, onChange, caps, hint, compact, disabled, disabledTitle }: {
  images: AssistantImage[];
  onChange: (images: AssistantImage[]) => void;
  caps: AssistantImageCaps;
  hint: string;
  // Chat composer variant: bare icon button while empty (assistant-chat.html
  // composer-footer).
