...
describe("RuntimeRestartModal", () => {
  it("shows the systemd alternative and the persistent waiting row for an offline machine", async () => {
    ...
    expect(screen.getByText(/systemctl --user restart lexa-machine-listener/)).toBeInTheDocument();
    expect(screen.getByText(/journalctl --user -u lexa-machine-listener/)).toBeInTheDocument();
