...
type HistoryResult = UseQueryResult<{ data: never[]; summary?: Record<RuntimeTaskStatus, number>; nextCursor?: string | null }, unknown>;
...
describe("paginationLabel", () => {
  it("shows the page size against the total (runtime-control-panel.html:304)", () => {
