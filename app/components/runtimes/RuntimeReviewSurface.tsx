...
interface RuntimeReviewSurfaceProps {
  action: string;
  runtime: string | null;
  diff: DiffResult;
  onAccept: () => void;
...
// Runtime review surface: a focused panel in the editor body — between the
...
export function RuntimeReviewSurface({ action, runtime, diff, onAccept, onReject }: RuntimeReviewSurfaceProps) {
