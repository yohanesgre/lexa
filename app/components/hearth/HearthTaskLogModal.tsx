...
const STATUS_META: Record<HearthTaskStatus, { label: string; color: string }> = {
...
function logToText(lines: HearthTaskLog[]): string {
...
export function HearthTaskLogModal({
  open,
  onClose,
  task,
  logs,
    ...
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 pointer-events-none">
        <dialog open className="dialog dialog-enter hearth-log-modal pointer-events-auto" aria-modal="true" aria-label="Hearth task log">
          ...
          <div className="hearth-log-modal-body">
