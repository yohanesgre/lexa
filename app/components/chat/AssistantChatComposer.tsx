...
function pastedImages(files: File[], current: AssistantImage[]): AssistantImage[] | null {
...
function ComposerFooter({
  ...
  setImages: (images: AssistantImage[]) => void;
  ...
  return (
    <>
      <div className="flex items-center gap-2">
        <AssistantImageAttach images={images} onChange={setImages} caps={CHAT_CAPS} hint="" compact disabled={attachDisabled} disabledTitle={ATTACH_DISABLED_TITLE_GLOBAL} />
