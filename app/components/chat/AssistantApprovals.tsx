...
// Approval chips for Assistant write proposals — transcribed from
// wireframes/src/assistant-write-approvals.html. Shared anatomy per chip:
// tool name (mono) · target ref (mono) · seq counter / status label ·
// diff body · Reject / Approve. Diff body shape follows the diff kind.
// Chip internals live in AssistantApprovalChipRow / AssistantDiffBody.
