...
import { chars, cap } from "./assistant-diff-utils";

// Shared diff primitives for Assistant approval chips — transcribed from
// wireframes/src/assistant-write-approvals.html.
