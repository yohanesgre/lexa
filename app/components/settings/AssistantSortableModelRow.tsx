...
import { useUpdateProviderModel } from "../../lib/queries/assistant-admin";
import type { AssistantProviderModel } from "../../../shared/assistant";

export function AssistantSortableModelRow({ providerId, model }: { providerId: string; model: AssistantProviderModel }) {
