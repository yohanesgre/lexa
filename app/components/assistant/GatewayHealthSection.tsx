...
type Circuit = AssistantProviderHealth["circuitState"];
...
export function GatewayHealthSection() {
  ...
  return (
    <section className="card-panel mt-4" id="runtime-usage-health">
      ...
      <p className="text-sm color-secondary mb-3" style={{ maxWidth: 640 }}>Circuit breaker for the Assistant gateway. Failures trip the breaker; half-open probes recovery. Probe forces a health check — use after fixing the upstream.</p>
      ...
      {isLoading ? (
        ...
        <div className="card-panel" style={{ overflow: "hidden", padding: 0 }}>
          <table className="settings-table settings-table--assistant-health">
