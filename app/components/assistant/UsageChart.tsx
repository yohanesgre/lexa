...
function drawChart(canvas: HTMLCanvasElement, rows: AssistantByDayRow[]): DrawGeometry {
...
export function UsageChart({
  ...
  const [hover, setHover] = useState<{ row: AssistantByDayRow; x: number; y: number } | null>(null);
  ...
  return (
    <section className="card-panel mt-4">
      ...
      <div className="chart-shell" ref={shellRef}>
        ...
        {hover ? (
          <div
            data-testid="assistant-chart-tooltip"
