...
const cases: Case[] = [
  ...
  { name: "listForgeAgents", call: () => api.listForgeAgents(), method: "GET", url: "/api/agents", response: { data: [] } },
  { name: "createForgeAgent", call: () => api.createForgeAgent({ name: "A", instructions: "i" }), method: "POST", url: "/api/agents", body: { name: "A", instructions: "i" }, response: { id: "a1" } },
  { name: "updateForgeAgent", call: () => api.updateForgeAgent("a1", { name: "B" }), method: "PATCH", url: "/api/agents/a1", body: { name: "B" }, response: { id: "a1", name: "B" } },
  ...
  { name: "resetForgeAgent", call: () => api.resetForgeAgent("a1"), method: "POST", url: "/api/agents/a1/reset", response: { id: "a1" } },
  { name: "listForgeSkills", call: () => api.listForgeSkills(), method: "GET", url: "/api/skills", response: { data: [] } },
  { name: "createForgeSkill", call: () => api.createForgeSkill({ name: "S", instructions: "i" }), method: "POST", url: "/api/skills", body: { name: "S", instructions: "i" }, response: { id: "s1" } },
  { name: "updateForgeSkill", call: () => api.updateForgeSkill("s1", { name: "S2" }), method: "PATCH", url: "/api/skills/s1", body: { name: "S2" }, response: { id: "s1", name: "S2" } },
  { name: "resetForgeSkill", call: () => api.resetForgeSkill("s1"), method: "POST", url: "/api/skills/s1/reset", response: { id: "s1" } },
