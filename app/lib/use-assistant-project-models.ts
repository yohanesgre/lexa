...
import { defaultsStep, hydrateStep } from "../components/settings/assistant-project-logic";
import type { ProviderLike } from "../components/settings/assistant-project-logic";

// Project Settings → Assistant provider model state: hydrate once from fetched
