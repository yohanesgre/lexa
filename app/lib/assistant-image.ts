...
export interface AssistantImageCaps {
  maxCount: number;
...
function rejectionFor(file: File, current: AssistantImage[], caps: AssistantImageCaps): string | null {
...
export function acceptImageFiles(files: File[], current: AssistantImage[], caps: AssistantImageCaps): { images: AssistantImage[]; rejection: string | null } {
