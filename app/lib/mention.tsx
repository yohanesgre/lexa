...
// mention chip, no delivery). Unknown @names render plain. The doc walk
// mirrors tiptap-render's renderNode/renderInline structure with the task
// variant classes; mention splitting lives here, single source for both
// CommentBody and any other comment rendering.
...
// Walk the doc and render it with mention chips for known member names.
// Returns null for empty docs (no wrapper element — the caller owns layout).
