import { classifyLogLine as classifyFallback, type LogLevel } from "../../shared/runtime-log";

// Line presentation: the daemon classifies severity ONCE at write time
// (shared/runtime-log.ts) and stores stream + level on the row — the UI renders
