...
VALUES
  ('seed-task-min-0', 'seed-proj-minimal', 'seed-col-min-0', NULL, 'Unassigned backlog bug', '{"type":"doc","content":[{"type":"paragraph","content":[{"type":"text","text":"A bug sitting in backlog with no owner."}]}]}', 'high', 'bug', 'Zz'),
  ('seed-task-min-1', 'seed-proj-minimal', 'seed-col-min-0', NULL, 'Low priority feature idea', '{"type":"doc","content":[{"type":"paragraph","content":[{"type":"text","text":"Nice to have someday."}]}]}', 'low', 'feature', 'a0'),
  ('seed-task-min-2', 'seed-proj-minimal', 'seed-col-min-1', NULL, 'WIP task with assignee', '{"type":"doc","content":[{"type":"paragraph","content":[{"type":"text","text":"Should be movable since assignee field present."}]}]}', 'medium', 'task', 'a0'),
  ('seed-task-min-3', 'seed-proj-minimal', 'seed-col-min-1', NULL, 'At WIP limit second task', '{"type":"doc","content":[]}', 'medium', 'task', 'a1'),
  ('seed-task-min-4', 'seed-proj-minimal', 'seed-col-min-2', NULL, 'Shipped feature', '{"type":"doc","content":[{"type":"paragraph","content":[{"type":"text","text":"Done and gone."}]}]}', 'medium', 'feature', 'a0');
...
VALUES
  ('seed-task-f-01', 'seed-proj-full', 'seed-col-f-0', 'seed-sw-f-0',
   ...
   'urgent', 'bug', 'a0', NULL, NULL, NULL, NULL),
  ...
  ('seed-task-f-02', 'seed-proj-full', 'seed-col-f-0', 'seed-sw-f-0',
   ...
   'high', 'feature', 'a1', NULL, NULL, NULL, NULL),
  ...
  ('seed-task-f-05', 'seed-proj-full', 'seed-col-f-0', 'seed-sw-f-2',
   ...
   'low', 'asset', 'a4', NULL, NULL, NULL, NULL),
  ...
  ('seed-task-f-08', 'seed-proj-full', 'seed-col-f-1', 'seed-sw-f-0',
   ...
   'medium', 'task', 'a2', NULL, NULL, NULL, NULL),
  ...
  ('seed-task-f-09', 'seed-proj-full', 'seed-col-f-2', 'seed-sw-f-0',
   ...
   'high', 'feature', 'a0', NULL, NULL, NULL, NULL),
  ...
  ('seed-task-f-10', 'seed-proj-full', 'seed-col-f-2', 'seed-sw-f-2',
   ...
   'medium', 'bug', 'a1', 'github_issue_99', 99, 'studio/emberfall', 'closed'),
  ...
  ('seed-task-f-13', 'seed-proj-full', 'seed-col-f-3', 'seed-sw-f-2',
   ...
   'medium', 'asset', 'a2', 'github_issue_77', 77, 'studio/emberfall', 'closed'),
